...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c125 = function(head, separator, bseparator) {
                return [ 
                        { 
                          name:'row',
                          type:'text',
  ...
  function peg$parsetableContents() {
    ...
    s4 = peg$currPos;
    peg$silentFails++;
    s5 = peg$parsetableHeadSeparator();
    peg$silentFails--;
    if (s5 === peg$FAILED) {
      s4 = void 0;
    } else {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        s8 = peg$currPos;
        peg$silentFails++;
        s9 = peg$parsetableBodyRowSeparator();
        peg$silentFails--;
        if (s9 === peg$FAILED) {
          s8 = void 0;
        } else {
