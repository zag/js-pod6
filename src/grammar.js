...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c22 = "=config",
      peg$c23 = peg$literalExpectation("=config", false),
      peg$c24 = "=",
      ...
      peg$c44 = function(pair, pairs) { return { ...pair, ...pairs } },
      peg$c45 = function(code) { return code },
      peg$c46 = ":",
      peg$c47 = peg$literalExpectation(":", false),
      peg$c48 = "allow",
      peg$c49 = peg$literalExpectation("allow", false),
      peg$c50 = "<",
      peg$c51 = peg$literalExpectation("<", false),
      peg$c52 = ">",
      peg$c53 = peg$literalExpectation(">", false),
      peg$c54 = function(key, array) { return { value:array, type:"array"}},
      peg$c55 = function(key, value) {return { name:'allow', ...value}},
      peg$c56 = function(i) {return i},
      peg$c57 = function(all) { return all },
      ...
      peg$c66 = function(isFalse, key, hash) { return { value:hash } },
      peg$c67 = "[",
      peg$c68 = peg$literalExpectation("[", false),
      peg$c69 = function(isFalse, key, array) { return array },
      peg$c70 = "]",
      peg$c71 = peg$literalExpectation("]", false),
      peg$c72 = function(isFalse, key) {return [text()]},
      peg$c73 = function(isFalse, key, array) { return   { 
                      value:array,
                      type:"array"
                    }  
          },
      peg$c74 = function(isFalse, key, array) { return { value:array, type:"array" } },
      peg$c75 = function(isFalse, key, array) { return { value:array, type:"string" } },
      peg$c76 = "(",
      ...
      peg$c81 = function(isFalse, key) {return { value:text() } },
      peg$c82 = function(isFalse, key, res) {
                  return { 
                          type:"value", 
                          ...res
                        }
              },
      peg$c83 = function(isFalse, key) { return { 
                  value:!isFalse,
                  type:"boolean"
                }
        },
      peg$c84 = function(isFalse, key, value) {return { name:key, ...value}},
      peg$c85 = function(first, rest) {return rest },
      peg$c86 = function(first, cont) {return [...first, ...cont].flat()},
      peg$c87 = /^[^'"]/,
      peg$c88 = peg$classExpectation(["'", "\""], true, false),
      peg$c89 = function(text) { return text},
      peg$c90 = /^[0-9]/,
      ...
      peg$c102 = /^[eE]/,
      peg$c103 = peg$classExpectation(["e", "E"], false, false),
      peg$c104 = /^["]/,
      ...
      peg$c112 = function(numberFloat) { return parseFloat(numberFloat) },
      peg$c113 = function(number) { return parseInt(number,10) },
      peg$c114 = function(vmargin, name, config) { 
           return ( 
      ...
      peg$c115 = function(vmargin, name, config, empty) { return {text: text(), type: "ambient"}},
      ...
      peg$c123 = function() { return { type:'separator', text:text() } },
      peg$c124 = function(t) { return { name:'row', type:'text', value:t } },
      peg$c125 = function(head, separator, rowtext, bseparator) {
                return [ 
                        { 
                          name:'row',
                          type:'text',
      ...
      peg$c126 = function(head, separator, singleRow) { return [singleRow] },
      peg$c127 = function(head, separator, rest) { return [
                        {
                          name:'head',
                          type:'text',
                          value:head
      ...
      peg$c128 = function(vmargin, name, config) { return name === 'table' },
      peg$c129 = function(vmargin, name, config, content, vmargin2, ename) { 
                            return {
                                    type:'block',
                                    content:content,
                                    name,
      ...
      peg$c130 = function(vmargin, name, config, nodes) { return true || name == name.toUpperCase() },
      peg$c131 = function(vmargin, name, config, nodes) { return nodes},
      peg$c132 = function(vmargin, name, config, tvmargin, text) {
      ...
      peg$c133 = function(vmargin, name, config, content, vmargin2, ename) { 
                  return { 
                          type:'block',
                          content,
                          name,
      ...
      peg$c134 = function(vmargin, name, config, content, vmargin2, res) { 
                  return { 
                          ...res,
                          text:text(),
                          config
      ...
      peg$c136 = function() { return  {empty:1}},
      peg$c137 = /^[s]/,
      peg$c138 = peg$classExpectation(["s"], false, false),
      peg$c139 = function(line) { return { text: text(), type: "ambient1"}},
      peg$c140 = function(vmargin, name) {  
           return ( 
             (name.match(/code|comment/))
              || 
              isNamedBlock(name)
      ...
      peg$c141 = function(vmargin, name, content) { 
          return {
                  margin:vmargin,
      ...
      peg$c142 = function(vmargin, name) { return name === 'table' },
      peg$c143 = function(vmargin, name, content) { 
          return {
                  margin:vmargin,
                  type: 'block',
                  content: content === "" ? [] 
      ...
      peg$c144 = function(vmargin, name, content) { 
          return {
                  margin:vmargin,
                  type:'block',
                  content: content === "" ? [] 
      ...
      peg$c145 = /^[A-Z]/,
      peg$c146 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c147 = "<>",
      peg$c148 = peg$literalExpectation("<>", false),
      peg$c149 = function(vmargin, marker, name, config) {
            return {
                name,
                type:'config',
                config,
      ...
      peg$c150 = function(vmargin, marker, name, config) {  
           return ( 
             (name.match(/code|comment/))
              || 
              isNamedBlock(name)
      ...
      peg$c151 = function(vmargin, marker, name, config, content) { 
            return { 
                    type: isNamedBlock(name) ? 'namedBlock' : 'block',
      ...
      peg$c152 = function(vmargin, marker, name, config) { return name === 'table' },
      peg$c153 = function(vmargin, marker, name, config, content) { 
            return { 
                    type: 'block',
                    content: content === "" ? [] : content,
                    name,
      ...
      peg$c154 = function(vmargin, marker, name, config, content) { 
            return { 
                    type:'block',
                    content: content === "" ? [] 
                                          : [
      ...
      peg$c160 = peg$otherExpectation("space characters"),
  ...
  function peg$parsetableContents() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        s3 = peg$parsetableHeadSeparator();
        if (s3 !== peg$FAILED) {
          s4 = [];
          s5 = peg$currPos;
          s6 = peg$currPos;
          ...
          if (s6 !== peg$FAILED) {
            s7 = peg$parsetableBodyRowSeparator();
            if (s7 !== peg$FAILED) {
              peg$savedPos = s5;
              s6 = peg$c125(s2, s3, s6, s7);
              s5 = s6;
            } else {
              peg$currPos = s5;
              s5 = peg$FAILED;
          ...
          if (s5 === peg$FAILED) {
            ...
            if (s6 !== peg$FAILED) {
              s7 = peg$parsetableRow();
              if (s7 !== peg$FAILED) {
                peg$savedPos = s5;
                s6 = peg$c126(s2, s3, s7);
                s5 = s6;
              } else {
                peg$currPos = s5;
                s5 = peg$FAILED;
                    ...
                    if (s10 !== peg$FAILED) {
                      ...
                      if (s11 !== peg$FAILED) {
                        ...
                        if (s12 !== peg$FAILED) {
                          ...
                          if (s13 !== peg$FAILED) {
                            peg$savedPos = s9;
                            s10 = peg$c129(s1, s3, s5, s7, s8, s11);
                            s9 = s10;
                          } else {
                            peg$currPos = s9;
                            s9 = peg$FAILED;
                  ...
                  if (s9 !== peg$FAILED) {
                    ...
                    if (s10 !== peg$FAILED) {
                      ...
                      if (s11 !== peg$FAILED) {
                        ...
                        if (s12 !== peg$FAILED) {
                          peg$savedPos = s8;
                          s9 = peg$c133(s1, s3, s5, s6, s7, s10);
                          s8 = s9;
                        } else {
                          peg$currPos = s8;
                          s8 = peg$FAILED;
