...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c120 = function() { return { type:'separator', text:text() } },
      peg$c121 = function(t) { return { name:'row', type:'text', value:t } },
      peg$c122 = function(head, separator, rowtext, bseparator) {
                return [ 
                        { 
                          name:'row',
                          type:'text',
      ...
      peg$c123 = function(head, separator, singleRow) { return [singleRow] },
      peg$c124 = function(head, separator, rest) { return [
                        {
                          name:'head',
                          type:'text',
                          value:head
      ...
      peg$c126 = function(vmargin, name, config, content, vmargin2, ename) { 
                            return {
                                    type:'block',
                                    content:content,
                                    name,
      ...
      peg$c127 = function(vmargin, name, config, nodes) { return true || name == name.toUpperCase() },
      peg$c128 = function(vmargin, name, config, nodes) { return nodes},
      peg$c129 = function(vmargin, name, config, tvmargin, text) {
      ...
      peg$c130 = function(vmargin, name, config, content, vmargin2, ename) { 
                  return { 
                          type:'block',
                          content,
                          name,
      ...
      peg$c131 = function(vmargin, name, config, content, vmargin2, res) { 
                  return { 
                          ...res,
                          text:text(),
                          config
      ...
      peg$c133 = function() { return  {empty:1}},
      peg$c134 = /^[s]/,
      peg$c135 = peg$classExpectation(["s"], false, false),
      ...
      peg$c138 = function(vmargin, name, content) { 
          return {
                  margin:vmargin,
      ...
      peg$c139 = function(vmargin, name) { return name === 'table' },
      ...
      peg$c144 = "=alias",
      peg$c145 = peg$literalExpectation("=alias", false),
      peg$c146 = function(vmargin, marker, name, replacement) {
            return {
                name,
                type:'alias',
                replacement,
      ...
      peg$c147 = /^[A-Z]/,
      peg$c148 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c149 = "<>",
      peg$c150 = peg$literalExpectation("<>", false),
      peg$c151 = function(vmargin, marker, name, config) {
            return {
                name,
                type:'config',
                config,
      ...
      peg$c152 = function(vmargin, marker, name, config) {  
           return ( 
             (name.match(/code|comment|output|input/))
              || 
              isNamedBlock(name)
      ...
      peg$c154 = function(vmargin, marker, name, config) { return name === 'table' },
      peg$c155 = function(vmargin, marker, name, config, content) { 
            return { 
                    type: 'block',
                    content: content === "" ? [] : content,
                    name,
      ...
      peg$c156 = function(vmargin, marker, name, config, content) { 
            return { 
                    type:'block',
                    content: content === "" ? [] 
                                          : [
      ...
      peg$c162 = peg$otherExpectation("space characters"),
                    ...
                    if (s10 !== peg$FAILED) {
                      ...
                      if (s11 !== peg$FAILED) {
                        ...
                        if (s12 !== peg$FAILED) {
                          ...
                          if (s13 !== peg$FAILED) {
                            peg$savedPos = s9;
                            s10 = peg$c126(s1, s3, s5, s7, s8, s11);
                            s9 = s10;
                          } else {
                            peg$currPos = s9;
                            s9 = peg$FAILED;
                  ...
                  if (s9 !== peg$FAILED) {
                    ...
                    if (s10 !== peg$FAILED) {
                      ...
                      if (s11 !== peg$FAILED) {
                        ...
                        if (s12 !== peg$FAILED) {
                          peg$savedPos = s8;
                          s9 = peg$c130(s1, s3, s5, s6, s7, s10);
                          s8 = s9;
                        } else {
                          peg$currPos = s8;
                          s8 = peg$FAILED;
