...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c8 = "V",
      peg$c9 = peg$literalExpectation("V", false),
      peg$c10 = "X",
      peg$c11 = peg$literalExpectation("X", false),
      peg$c12 = "Z",
      peg$c13 = peg$literalExpectation("Z", false),
      peg$c14 = peg$anyExpectation(),
      peg$c15 = function(name) {return name === "V"},
      peg$c16 = function(name, content) {  
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c24 = function(text) {return text},
      peg$c25 = function(name) {return name === "C"},
      peg$c26 = function(name, content) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c29 = function(name) {return name === "L"},
      peg$c30 = function(name, content, t) { return t },
      peg$c31 = function(name, content, meta) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c34 = /^[ \xA0\u2001\t\f\u2008]/,
      peg$c35 = peg$classExpectation([" ", "\xA0", "\u2001", "\t", "\f", "\u2008"], false, false),
      peg$c36 = function(code, codes) { return [ code, codes ].flat() },
      peg$c37 = function(code) { return [code] },
      peg$c38 = function(name) {return name === "X"},
      peg$c39 = function(name, content, t) { return t.flat() },
      peg$c40 = function(name, content, entry) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c41 = function(name) {return name === "S"},
      peg$c42 = function(name) {return name === "Z"},
      peg$c43 = function(name) { return name },
      peg$c44 = function(name) { return name !== 'C' },
      peg$c45 = function(name, content) { return {content, type:'fcode', name}},
