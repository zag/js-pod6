...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c18 = function(name) {return name === "C"},
      peg$c19 = function(name, content) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c22 = function(name) {return name === "L"},
      peg$c23 = function(name, content, t) { return t },
      peg$c24 = function(name, content, meta) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c27 = /^[ \xA0\u2001\t\f\u2008]/,
      peg$c28 = peg$classExpectation([" ", "\xA0", "\u2001", "\t", "\f", "\u2008"], false, false),
      peg$c29 = function(code, codes) { return flattenDeep([ code, codes ]) },
      peg$c30 = function(code) { return [code] },
      peg$c31 = function(name) {return name === "X"},
      peg$c32 = function(name, content, t) { return flattenDeep(t) },
      peg$c33 = function(name, content, entry) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c34 = function(name) {return name === "S"},
      peg$c35 = function(name) {return name === "Z"},
      peg$c36 = function(name) { return name },
      peg$c37 = function(name) { return name !== 'C' },
      peg$c38 = function(name, content) { return {content, type:'fcode', name}},
