...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c13 = function(name) {return name === "V"},
      peg$c14 = function(name, content) {  
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c20 = function(text) {return text},
      peg$c21 = function(name) {return name === "C"},
      peg$c22 = function(name, content) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c25 = function(name) {return name === "L"},
      peg$c26 = function(name, content, t) { return t },
      peg$c27 = function(name, content, meta) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c30 = /^[ \xA0\u2001\t\f\u2008]/,
      peg$c31 = peg$classExpectation([" ", "\xA0", "\u2001", "\t", "\f", "\u2008"], false, false),
      peg$c32 = function(code, codes) { return flattenDeep([ code, codes ]) },
      peg$c33 = function(code) { return [code] },
      peg$c34 = function(name) {return name === "X"},
      peg$c35 = function(name, content, t) { return flattenDeep(t) },
      peg$c36 = function(name, content, entry) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c37 = function(name) {return name === "S"},
      peg$c38 = function(name) {return name === "Z"},
      peg$c39 = function(name) { return name },
      peg$c40 = function(name) { return name !== 'C' },
      peg$c41 = function(name, content) { return {content, type:'fcode', name}},
