...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c22 = function(text) {return text},
      peg$c23 = function(name) {return name === "C"},
      peg$c24 = function(name, content) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c27 = function(name) {return name === "L"},
      peg$c28 = function(name, content, t) { return t },
      peg$c29 = function(name, content, meta) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c32 = /^[ \xA0\u2001\t\f\u2008]/,
      peg$c33 = peg$classExpectation([" ", "\xA0", "\u2001", "\t", "\f", "\u2008"], false, false),
      peg$c34 = function(code, codes) { return flattenDeep([ code, codes ]) },
      peg$c35 = function(code) { return [code] },
      peg$c36 = function(name) {return name === "X"},
      peg$c37 = function(name, content, t) { return flattenDeep(t) },
      peg$c38 = function(name, content, entry) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c39 = function(name) {return name === "S"},
      peg$c40 = function(name) {return name === "Z"},
      peg$c41 = function(name) { return name },
      peg$c42 = function(name) { return name !== 'C' },
      peg$c43 = function(name, content) { return {content, type:'fcode', name}},
