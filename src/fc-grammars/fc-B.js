...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c6 = function(name) {return name === "V"},
      peg$c7 = function(name, content) {  
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c13 = function(text) {return text},
      peg$c14 = function(name) {return name === "C"},
      ...
      peg$c18 = function(name) {return name === "L"},
      peg$c19 = function(name, content, t) { return t },
      peg$c20 = function(name, content, meta) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c23 = /^[ \xA0\u2001\t\f\u2008]/,
      peg$c24 = peg$classExpectation([" ", "\xA0", "\u2001", "\t", "\f", "\u2008"], false, false),
      peg$c25 = function(code, codes) { return flattenDeep([ code, codes ]) },
      peg$c26 = function(code) { return [code] },
      peg$c27 = function(name) {return name === "X"},
      peg$c28 = function(name, content, t) { return flattenDeep(t) },
      peg$c29 = function(name, content, entry) {
               return  { 
                      content,
                      'type':"fcode",
                      name,
      ...
      peg$c30 = function(name) {return name === "S"},
      peg$c31 = function(name) {return name === "Z"},
      peg$c32 = function(name) { return name },
      peg$c33 = function(name) { return name !== 'C' },
      peg$c34 = function(name, content) { return {content, type:'fcode', name}},
